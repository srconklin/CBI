...
<head>
  ...
  <link rel="stylesheet" href="/dist/app-QJJMHNZP.css">
...
<!--- <a href="#" id="open_preferences_center">Update cookies preferences</a> --->
 <script src="/dist/app-UJVLEOU6.js" type="module" data-cookie-consent="strictly-necessary" ></script>
...
<body x-cloak x-data="{hidden: false}" @blur-bg.window="$event.detail?hidden = true:hidden=false; window.scroll({top: 0, left: 0, behavior: 'smooth'});" :class="{ 'no-scroll': hidden }"> 
  ...
  <script src="https://www.google.com/recaptcha/api.js?render=6LevHMkfAAAAAInPcjzzNLUUgvmKoeDzcIg4G6qS" async></script>

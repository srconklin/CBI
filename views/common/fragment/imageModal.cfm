...
<div x-data="{ imgModalSrc : '', zoom: false, rightBoundary : 0}" >
    <div @img-modal.window="imgModalSrc = $event.detail.imgModalSrc" x-show="imgModalSrc" >
    <!--- <template @img-modal.window="imgModalSrc = $event.detail.imgModalSrc" x-if="imgModalSrc" > --->
        <div x-ref="imageModal" id="imageModal" class="image-modal"
            ...
            <div id="img-container" @click.away="imgModalSrc = ''" class="image-modal-main">
             ...
             <svg x-show="!zoom"
                @mouseenter="zoom= !zoom;document.getElementById('largeImage').style.objectFit= 'cover'" 
                xmlns="http://www.w3.org/2000/svg" class="zoom" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0zM10 7v3m0 0v3m0-3h3m-3 0H7" />
            </svg>
            <svg
                x-show="zoom" 
                @mouseleave="zoom= !zoom;document.getElementById('largeImage').style.objectFit= 'contain'" 
                xmlns="http://www.w3.org/2000/svg" class="zoom" fill="none" viewBox="0 0 24 24" stroke="currentColor">

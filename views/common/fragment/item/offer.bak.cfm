<div class="offer">
	<form id="offerfrm" action="/offer" method="post" x-data x-init="$store.offer.init()"  @submit.prevent="$store.offer.submit()">
			...
			<div class="offer-total-row">
				...
				<div>
					<div class="input-group">
						...
						<input name="pricestated" type="text" class="form-control input-group-ele currency-ele" :class="{'invalid':$store.offer.pricestated.errorMessage && $store.offer.pricestated.blurred}"  placeholder="999,999.00" oninput="this.value=formatCurrency(this.value);"  @blur="$store.offer.validatePrice($event, 'blur')" maxlength="10"  x-model="$store.offer.pricestated.value" required/>
					</div>
		...
		<div class="form-row">
			...
			<textarea cols="50" rows="3" name="terms" wrap="soft" class="form-control" x-model="$store.offer.terms" onblur="this.value = stripHTML(this.value);" maxlength="250"  ></textarea>
		...
		<div class="form-row">
			...
			<textarea cols="50" rows="3" name="message" wrap="soft" class="form-control" onblur="this.value = stripHTML(this.value);" x-model="$store.offer.message" maxlength="250"></textarea>
			<p class="count" x-cloak>

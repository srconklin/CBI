<div id="about" class="general-page">
  ...
  <section class="about-header mt-2 full-width">
  ...
  <div class="container">
      <section class="mt-6">
              ...
              <h2 class="mb-2">Buyer and Seller of Quality Used Equipment</h2>
              ...
              <h2 class="mb-2">Vast and Diverse Product Inventory</h2>
              ...
              <h2 class="mb-2">International Customer Base</h2>
              ...
              <h2 class="mb-2">Gaurenteed Qaulity Control</h2>
              ...
              <h2 class="mb-2">Top Notch Service</h2>
              ...
              <h2 class="mb-2">Exceptional Value</h2>
